...
public interface BingoOpperations extends Remote {//Δημιουργούμε τήν κατάλληλη διεπαφή για τον εξυπηρετητή(BingoServer) κληρονομόντας απο την κλάση Remote και καλόντας τις αντίστειχες εξαιρέσεις
